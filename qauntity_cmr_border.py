...
"}")
        ...
        self.gridLayout.addWidget(self.btn_brd_qunt_ok, 5, 0, 1, 3)
...
"}")
        ...
        self.gridLayout.addWidget(self.lbl_brd_cmr, 3, 2, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.spn_qunt, 3, 1, 1, 1)
