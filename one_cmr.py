...
"}")
        ...
        self.gridLayout.addWidget(self.cmb_contr_dest, 3, 1, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_qunt_cll.sizePolicy().hasHeightForWidth())
        self.lbl_qunt_cll.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("RussoOne-Regular")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout.addWidget(self.lbl_qunt_cll, 4, 0, 1, 1)
        self.lbl_countr_dest = QtWidgets.QLabel(parent=one_cmr)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_countr_dest.sizePolicy().hasHeightForWidth())
        self.lbl_countr_dest.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("RussoOne-Regular")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout.addWidget(self.lbl_countr_dest, 3, 0, 1, 1)
        self.lbl_count_disp = QtWidgets.QLabel(parent=one_cmr)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_count_disp.sizePolicy().hasHeightForWidth())
        self.lbl_count_disp.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("RussoOne-Regular")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout.addWidget(self.lbl_count_disp, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.qaunt_cll, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cmb_count_disp, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_pakage, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.cmb_pakage, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_add_doc, 6, 0, 1, 2)
